const flowers = [
  {
    imageUrl: "https://s2-g1.glbimg.com/-0QM0ax64PlQp7wAVOmx8SUrjTQ=/0x0:620x412/1000x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_59edd422c0c84a879bd37670ae4f538a/internal_photos/bs/2018/E/F/2OODNaSUGxe6MJwk5awA/ipe-amarelo-ananda-porto.jpg",
    name: "Ipê-amarelo",
  ...
  {
    imageUrl: "https://minhasplantas3.s3.amazonaws.com/media/duvidas/perguntas/Adubo-Bromelia.jpg",
    name: "Bromélia",
  ...
  {
    imageUrl: "https://inpn.mnhn.fr/photos/uploads/webtofs/inpn/4/276414.jpg",
    name: "Clúsia",
    ...
    floweringPeriod: "Primavera.",
    cultivation: "Sol pleno ou meia sombra, solo bem drenado.",
...
function updateFlower(flowers) {
  ...
  section.innerHTML = flowers.map(renderFlower).join('');
}
